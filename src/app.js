...
//             //         options: {
//             //             partition: 'prodalamservercookies',
...
//         //         console.log("validate REQ", request);
...
//         //             let tokenredis = await request.redis.client.hget('prodalammobile', decoded.iss)
...
//         //             let tokenredis = await request.redis.client.get(`prodalamrestorepassword-${decoded.id}`)
